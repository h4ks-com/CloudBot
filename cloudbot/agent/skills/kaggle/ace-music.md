---
name: ace-music
description: Generate a song (wav) from lyrics + a style prompt using the open ACE-Step model on Kaggle GPU. Use for explicit ACE-Step requests or an open-model/self-hosted song; for a quick song the main path is a workflows song job.
---
